	...
	<div id="content">
		<div id="left">
				...
				<tr>
					...
					<td>
						<select id = "uchoice">
							 ...
							 <option value = "pricing_b">Unit B</option>
							 <option value = "pricing_c">Unit C</option>
							 <option value = "pricing_d">Unit D</option>
						</select>
					</td>
				</tr>
				<tr>
			...
			<div id="calendar-container" >
				<div id = "prev-next">
					<a href="" id="prev"><img src="<?= base_url(); ?>images/left.png" width="35"></a>
					<a href="" id="next"><img src="<?= base_url(); ?>images/right.png" width="35"></a>
				<div class="clear"></div>
				</div>
				<div id="calendar"></div>
		...
		<div id="right">
			...
			<div class="clear"></div>
			<button id = "print" style="padding: 10px 20px; float: right; margin-top: 70px;">Make printable PDF file </button>
		</div><!-- #right -->
		<div class="clear"></div>
	</div><!-- #content -->
